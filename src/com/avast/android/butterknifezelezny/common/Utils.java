...
public class Utils {
    ...
    public static boolean isInitButterKnifeDefault() {
        String value = PropertiesComponent.getInstance().getValue(Settings.INIT_BUTTERKNIFE, "true");
    ...
    public static boolean isInLibraryDefault() {
        String value = PropertiesComponent.getInstance().getValue(Settings.IN_LIBRARY, "false");
        if (value.equals("true")) {
            return true;
        } else {
            return false;
